...
Puede acceder a https://library.netapp.com/ecm/ecm_download_file/ECMLP2879854["Notas de la versión de ONTAP Select 9.10.1"^] para ver los detalles acerca de la versión actual.
